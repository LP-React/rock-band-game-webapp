...
- Muted playback exposes a prominent sound-activation prompt at the top center (above the player on mobile). Enabling sound removes the prompt; the player retains a compact mute control. Existing muted-autoplay attempts and browser-blocked playback fallback remain in place.
